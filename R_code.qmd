...
class StanQuap(object):
    ...
    def __init__(self,
        ...
        self.generated_quant = generated_quant
        self.params = self.opt_model.stan_variables()
        self.opt_params = {param: self.params[param] for param in self.params.keys() if param not in self.generated_quant}
    ...
    def extract_samples(self, n: int = 100_000, dict_out: bool = True):
        ...
        if dict_out:
            ...
            return {param: stan_var_dict[param] for param in stan_var_dict.keys() if param not in self.generated_quant}
    ...
    def sim(self, data: dict = None, n = 1000, dict_out: bool = True):
        ...
        if dict_out:
            stan_var_dict = laplace_obj.stan_variables()
            return {param: stan_var_dict[param] for param in stan_var_dict if param in self.generated_quant}
        return laplace_obj.draws()      
