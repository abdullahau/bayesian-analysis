...
utils.inline_plot(plot_beta_pos)
```
...
utils.inline_plot(posterior_predictive_plot)
```
...
utils.inline_plot(plot_grid_approx)
```
...
$$
\begin{align*}
 Pr(B_1,W_2) &= Pr(W_2\|B_1,B/B)Pr(B_1\|B/B)Pr(B/B) + Pr(W_2\|B_1,B/W)Pr(B_1\|B/W)Pr(B/W) \\
...
The terms **PMF**, **PDF, CDF**, and **PPF** are fundamental concepts in probability and statistics, each describing different aspects of probability distributions. Here's a detailed explanation of each:
